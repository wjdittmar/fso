...
// and then function itself returns a boolean
// typescript will then known that if you call 
// return is !isString, then afterwards in the function
// typescript infers that the variable is a string
